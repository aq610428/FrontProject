 ...
 * @name:StockAdapter
 */
public class OwnerTeAdapter extends AutoRVAdapter {
    private List<DemoBean> keeps = new ArrayList<>();


    public OwnerTeAdapter(Context context, List<DemoBean> list) {
        super(context, list);
        this.keeps = list;
    }
    ...
    public int onCreateViewLayoutID(int viewType) {
        return R.layout.item_keep_owner;
    }
    ...
    public void onBindViewHolder(ViewHolder vh, int position) {
        ...
        vh.getTextView(R.id.text_license).setText(keepInfo.getCardNum()+"");
