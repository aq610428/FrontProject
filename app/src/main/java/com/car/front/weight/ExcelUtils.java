...
import com.car.front.ui.fragment.OwnerFragment;
...
public class ExcelUtils {
    ...
    public static <T> void writeObjListToExcel(ArrayList<ArrayList<String>> objList, String fileName, Context c) {
...
//				sheet.mergeCells()
                ...
                writebook.write();
                ToastUtil.showToast("导出到手机存储中文件夹StoreCarBar成功");
            } catch (Exception e) {
                e.printStackTrace();
            } finally {
                if (writebook != null) {
     ...
     * @return
     */
    public static ArrayList<ArrayList<String>> getRecordData(List<DemoBean> list) {
        ArrayList<ArrayList<String>> recordList = new ArrayList<>();
        for (int i = 0; i < list.size(); i++) {
            DemoBean student = list.get(i);
            ArrayList<String> beanList = new ArrayList<String>();
            beanList.add(student.getCardNum());
            beanList.add(student.getName());
            beanList.add(student.getModel());
            beanList.add(student.getFaults());
